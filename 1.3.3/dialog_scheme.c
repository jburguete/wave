...
void dialog_scheme_create()
{
	...
	char *string_schemes[N_SCHEMES] = {"Lax-Friedrichs",
		...
		gettext("2nd order upwind"),gettext("Classical spatial 2nd order TVD"),
	...
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->convergence,
		0, 0, 2, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->frame_discretizations,
		0, 1, 2, 3);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->frame_meshes,
		0, 4, 2, 4);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->label_mesh_cells,
		0, 8, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->entry_mesh_cells,
		1, 8, 1, 1);
	...
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->entry_simulation_time,
		1, 9, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->label_cfl,
		0, 10, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->entry_cfl,
		1, 10, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->label_implicit,
		0, 11, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->entry_implicit,
		1, 11, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->label_viscosity,
		0, 12, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->entry_viscosity,
		1, 12, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->label_dxmax,
		0, 13, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->entry_dxmax,
		1, 13, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->label_max_cells,
		0, 14, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->entry_max_cells,
		1, 14, 1, 1);
	...
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->entry_convergence_number,
		1, 15, 1, 1);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->frame_schemes,
		3, 0, 1, 19);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->frame_entropy,
		4, 0, 1, 7);
	gtk_grid_attach(dlg->table, (GtkWidget*)dlg->frame_limiters,
		4, 7, 1, 12);
